...
{	
    ...
    public function index(){
    	if(isLogin()){
    		...
    		$field = 'user_id,user_nickname,user_name,user_avatar,user_sign,user_birthday,user_sex,user_description,user_signature,user_province,user_city,user_avatar';
