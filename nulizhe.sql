...
ALTER TABLE `nl_user` CHANGE `user_description` `user_description` TEXT CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '//用户简介';
ALTER TABLE `nl_user` CHANGE `user_province` `user_province` VARCHAR(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '//省份名';
ALTER TABLE `nl_user` CHANGE `user_city` `user_city` VARCHAR(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '//城市名';
ALTER TABLE `nl_user` CHANGE `user_signature` `user_signature` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '//用户个性签名';